<%-- 
    ...
    Created on : Sep 2, 2022, 3:29:37 AM
    Author     : ASUS
--%>
    ...
    <div class="row">
        <div class="col-3">
            <ul class="nav-links">
                ...
                <li>
                    <a class="active" href="<c:url value="/companyMn/frequency-stat"/>">
                        <i class="fa-solid fa-chart-pie"></i>
        ...
        <div class="col-9">
            <div class="information">
                <div class="qlbx-div">
                    <label class="fw-bold px-3 py-2">Thống Kê Tần Suất Các Tuyến Đi</label>
                </div>
                <div class="qlbx-div mt-3 px-3 py-2">
                    <div class="stat-by-month">
                        <label class="py-2">Thống kê theo tháng</label>
                        <form action="<c:url value="/companyMn/frequency-stat"/>">
                            <div class="row">
                                <div class="col">
...
<script type="text/javascript">
    ...
    window.onload = function () {
        frequencyStat(labelInfos, datas);
    }
</script>